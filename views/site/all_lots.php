            ...
            <tbody>
                <?php foreach ($lots as $lot): ?>
                    <tr>
                        ...
                        <td><?= $lot->has_keys ? Html::a('<i class="fas fa-check"></i>', ['site/gallery', 'id' => $lot->id], ['target' => '_blank']) : '' ?></td>
                        <td><?= $lot->bos ? Html::a('<i class="fas fa-check"></i>', ['site/gallery', 'id' => $lot->id], ['target' => '_blank']) : '' ?></td>
                        <td><?= $lot->title ? Html::a('<i class="fas fa-check"></i>', ['site/gallery', 'id' => $lot->id], ['target' => '_blank']) : '' ?></td>
                        ...
                        <td><?= $lot->video ? Html::a('<i class="fas fa-check"></i>', ['site/gallery', 'id' => $lot->id], ['target' => '_blank']) : '' ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
